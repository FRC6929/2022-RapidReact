...
public class Robot extends TimedRobot {
  ...
  private Compressor comp = new Compressor(0, PneumaticsModuleType.CTREPCM);
  ...
  public void robotInit() {
    ...
    SmartDashboard.setDefaultNumber("Auto Distance(cm)", 250);
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putBoolean("AlertPression",!comp.getPressureSwitchValue());
