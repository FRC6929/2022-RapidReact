...
public class Shooter extends SubsystemBase {
  ...
  public final CANSparkMax m_pivot = new CANSparkMax(Constants.ConsShooter.MoteurGrosSus, MotorType.kBrushless);
  public final DigitalInput ShooterLimit = new DigitalInput(0);
  public final DigitalInput ShooterLimit2 = new DigitalInput(1);
  ...
  public void pivotd(double speed) {
   m_pivot.set(speed);
  }
}